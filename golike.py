...
{colored('════════════════════════════════════════════════', 'white')}
{colored('[❣] Tool     : ☞ Tik - Tok♔ 🔫', 'white')}
{colored('[❣] Tên   : ☞ BÓNG X - Kiếm Tiền Online♔ ☜', 'white')}
{colored('[❣] Tik Tok  : https://www.tiktok.com/@doanh21105', 'white')}
{colored('[❣] Zalo     : ☞032166863☜', 'white')}
{colored('[❣] Telegram : ☞https://t.me/doanhvip1🔫☜', 'white')}
{colored('════════════════════════════════════════════════', 'white')}
{colored('[❣] Lưu ý    : ☞ Tool Sử Dụng Cho Android♔ ☜', 'white')}
{colored('════════════════════════════════════════════════', 'white')}
"""
    print(banner_text)
